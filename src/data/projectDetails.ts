...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  "3d-printing-prototyping": {
    overview:
      "An iterative design and fabrication project focused on producing functional mechanical components using CAD tools and FDM 3D printing. The work centred on rapid design cycles — testing structural constraints, tolerances, and fit — to develop reliable parts for small-scale engineering systems.",
    sections: [
      {
        title: "Design Process",
        items: [
          "Component design in SolidWorks with engineering tolerances",
          "Iterative prototyping cycles — design, print, test, refine",
          "Structural constraint analysis before fabrication",
          "Assembly-level fitting and functional testing",
        ],
      },
      {
        title: "Fabrication & Tooling",
        items: [
          "FDM 3D printing with PLA and PETG materials",
          "Post-processing for dimensional accuracy",
          "Custom support and infill strategies for structural parts",
        ],
      },
      {
        title: "Engineering Skills Developed",
        items: [
          "Parametric CAD modelling and drawing production",
          "Tolerance analysis for mechanical fit",
          "Material selection for functional prototypes",
          "Rapid iteration under design constraints",
        ],
      },
      {
        title: "Future Improvements",
        items: [
          "Expansion into multi-material and composite printing",
          "FEA-driven design optimisation before fabrication",
          "Larger-scale structural component design",
        ],
      },
    ],
  },
